    ...
    <div>
      <Container className="mt-6 md:mt-24">
        <div className="space-y-6 px-2 lg:px-12">
          <div className="border-t border-dashed pt-9 md:pt-16"></div>
          {tds_content.map((content) => (
            <div key={content.id} className="bg-white p-6 md:p-8 rounded-3xl flex items-center">
              <div className="border-r border-dashed lg:pr-12 w-40 hidden md:flex justify-center">
                <img src={content.image} alt="" className="max-w-28 max-h-28" />
              </div>

              <div className="lg:pl-12">
                <h2 className="text-xl md:text-2xl font-bold mb-2 text-secondary">
                  {content.headLine}
                </h2>
